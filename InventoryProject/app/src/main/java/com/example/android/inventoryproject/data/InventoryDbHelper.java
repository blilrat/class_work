 ...
 * Database helper for InventoryProject app. Manages database creation and version management.
 */
public class InventoryDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_INVENTORY_TABLE = "CREATE TABLE " + InventoryEntry.TABLE_NAME + " ("
                ...
                + InventoryEntry.COLUMN_PRICE + " DOUBLE, "
                + InventoryEntry.COLUMN_QTY_AVAILABLE + " INTEGER NOT NULL DEFAULT 0, "
