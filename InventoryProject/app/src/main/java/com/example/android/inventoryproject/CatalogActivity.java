...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertInventory() {
        ...
        // and the test item attributes are the values.
        ContentValues values = new ContentValues();
        values.put(InventoryEntry.COLUMN_ITEM_NAME, "Debug Item");
        values.put(InventoryEntry.COLUMN_PRICE, 100.50);
        values.put(InventoryEntry.COLUMN_QTY_AVAILABLE, 5);
        values.put(InventoryEntry.COLUMN_SUPPLIER, "Debug Supplier");
